...
const { Interaction, CategoryChannel, TextChannel, Collection } = require('discord.js');
const {
        ...
        if (interaction.isButton()) {
            ...
            if (button.startsWith('adicionar_produto_')) {
                ...
                try {
                    ...
                    const msgErro = 'Erro ao processar os dados do carrinho';
